...
class SampleDictTest(unittest.TestCase):
    ...
    def test_does_not_error_on_same_hash_diff_key(self):
        mock_hash_value = SampleDict._hash(b'a')
        with patch('python_dict.SampleDict._hash', lambda self, key: mock_hash_value):
    ...
    def test_dict_resizes_when_it_fills_up(self):
        for i in range(90):
